...
def process_tree(inputCfg):
    ...
    hDcax1Chi2MatchMCHMFTFullPM = ROOT.TH2F("LHC23_full_PairsMuonSEPM_matchedQualityCuts_Dcax1Chi2MatchMCHMFT","Dimuon Dca x1 - #varphi SEPM ;DCA X1;#varphi", 500, -1, 1, 500, 0, 100)
    hDcay1Chi2MatchMCHMFTFullPM = ROOT.TH2F("LHC23_full_PairsMuonSEPM_matchedQualityCuts_Dcay1Chi2MatchMCHMFT","Dimuon Dca y1 - #varphi SEPM ;DCA Y1;#varphi", 500, -1, 1, 500, 0, 100)
        ...
        for posx, posy, posz, mass, tauz, tauxy, sign, sign1, sign2, eta, eta1, eta2, phi, phi1, phi2, pt, pt1, pt2, dcax1, dcax2, dcay1, dcay2, chi2mchmft1, chi2mchmft2 in zip(
            ...
            accumulatedData['fChi2MatchMCHMFT2']):
                if sign == 0:
                    ...
                    hDcax1Chi2MatchMCHMFTFullPM.Fill(dcay1, chi2mchmft1)
